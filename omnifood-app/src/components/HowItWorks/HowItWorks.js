...
const HowItWorks = () => {
    return(
        <section className='section-how'>
            ...
            <ContainerGrid className="grid grid-2-cols">
...
{/* step 1 */}
                ...
                <div className='step-img-box'>
                    <img src={step1Img} className='step-img' alt="iPhone app preferences selection screen"/>
                </div>

{/* step 2 */}
                <div className='step-img-box'>
                    <img src={step2Img} className='step-img' alt="iPhone app delivery screen"/>
                </div>
...
<div className='step-text-box'>
                ...
                <div className='step-img-box'>
                    <img src={step3Img} className='step-img' alt="iPhone app preferences selection screen"/>
                </div>
            </ContainerGrid>
        </section>
